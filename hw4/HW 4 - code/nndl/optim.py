...
def sgd_nesterov_momentum(w, dw, config=None):
    ...
    #   as next_w, and the updated velocity as v.
    # ================================================================ #
    # lr, mmt = config['learning_rate'], config['momentum']
...
def rmsprop(w, dw, config=None):
    ...
    nu = config['epsilon']
    next_w = w - config['learning_rate'] * dw / (np.sqrt(config['a']) + nu)
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
...
def adam(w, dw, config=None):
    ...
    nu = config['epsilon']
    v_bias = config['v'] / (1 - np.power(config['beta1'], config['t']))
    a_bias = config['a'] / (1 - np.power(config['beta2'], config['t']))
    next_w = w - config['learning_rate'] * v_bias / (np.sqrt(a_bias) + nu)
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
